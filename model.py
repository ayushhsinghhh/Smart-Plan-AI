...
routing_path  = Path("D:" + os.sep + "SmartPlanAI-main")

color_dir = Path(str(routing_path) + os.sep + "Dataset" + os.sep + "Database" + os.sep + "colors")
walls_dir = Path(str(routing_path) + os.sep + "Dataset" + os.sep +"Database" + os.sep + "walls")
